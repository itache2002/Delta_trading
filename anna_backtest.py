    ...
    for i in range(1, len(filtered_data)):
        ...
        if not bt.paused:
            if data['crossup'] == 1:
                ...
                bt.buy('SilverMIC', data['time'], data['open'], qty)
...
# bt.backtesting['Entry Time'] = bt.backtesting['Entry Time'].dt.tz_localize(None)
# bt.backtesting['Exit Time'] = bt.backtesting['Exit Time'].dt.tz_localize(None)
df.to_excel('output_anna.xlsx', index=False)