...
# Sample API request
r = requests.get('https://api.delta.exchange/v2/history/candles', params={'resolution': '15m', 'symbol': 'BTCUSDT', 'start': '1698802110', 'end': '1703986110'}, headers=headers)
...
print(df)
open_price = 0
difference = abs(open_price - df['close'] )
